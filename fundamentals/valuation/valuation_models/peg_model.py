...
class PEGValuationModel(BaseValuationModel):
    ...
    def calculate_fair_value(self, stock_data: StockData, benchmark_data: Any, sector: str) -> Optional[float]:
        try:
            ...
            # Cap upside: fair value cannot exceed 3x current price.
            # This prevents tiny PEG ratios (e.g., hyper-growth stocks) from
            # producing wildly unrealistic outputs (e.g., price / 0.07 = 14x price).
            max_fair_value = current_price * 3.0
